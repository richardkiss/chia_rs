...
class Block2026Builder:
    ...
    def add_candidate(self, bundle: SpendBundle, irreducible_cost: int) -> None: ...
    def start(self) -> None: ...
    def best(self) -> tuple[bytes, G2Element, int, list[int]]: ...
    def close(self) -> None: ...
    def improve(self) -> bool: ...
    def num_included(self) -> int: ...
    def __enter__(self) -> Self: ...
    def __exit__(self, exc_type: Any = None, exc_val: Any = None, exc_tb: Any = None) -> bool: ...
